...
export default function Integrations() {
   ...
   useEffect(() => {
    setTimeout(() => {
        ...
        if (code) {
            fetch(`${process.env.REACT_APP_API || 'http://localhost:4090'}/integrations/linkedin/save/${code}`, {
                method: 'POST',
                credentials: 'include',
                headers: {
            ...
            .then((data) => {
                console.log(data);
                window.location.href = '/integrations?integration=linkedin&success=true';
            });
        }
    }, 4000);
    }, []);
