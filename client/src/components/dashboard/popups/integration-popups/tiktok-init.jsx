...
function TikTok({ isOpen, setIsOpen, isTiktok, setIsTiktok }) {
                                    ...
                                    <div>
                                        <div className="mt-10 flex max-w-[400px] flex-col m-auto">
                                            <div className="flex justify-center items-center">
                                                <img src="/images/logos/tiktok.webp" alt="TikTok" className="h-20 w-20 m-auto" />
                                            </div>
                                            <p className="mt-10">By connecting TikTok, you will be able to publish videos to your TikTok account.</p>
                                        </div>
                                    </div>
                                    <div className="mt-6 flex items-center justify-center">
                                        <Link
                                            to={`${process.env.REACT_APP_API}/integrations/tiktok/authorize`}
                                            type="button"
