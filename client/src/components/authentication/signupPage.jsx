    ...
    */}
    <div className="flex min-h-full flex-1 mt-10">
        <div className="mx-auto w-full max-w-sm lg:max-w-[480px]">
          ...
          <div className="">
            <div>
              <form method="POST" action={`${process.env.REACT_APP_API || 'http://localhost:4090'}/users/signup`} className="space-y-6">
          ...
          <div className="relative">
              ...
              <div className="mt-6">
                <a
                  ...
                  className="flex w-full items-center justify-center gap-3 rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-200 focus-visible:ring-transparent"
                >
          ...
          <p className="text-sm my-6 leading-6 text-center text-gray-500">
              Already a member?{' '}
              <Link to="/login" className="font-semibold text-indigo-600hover:text-indigo-500">
                Log in
              </Link>
            </p>
